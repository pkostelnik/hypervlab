...
| Windows Server 2025 |[x]|<https://www.microsoft.com/en-us/evalcenter/evaluate-windows-server-2025>|
...
| Microsoft SQL Server 2025 |[x]|<https://www.microsoft.com/en-us/evalcenter/evaluate-sql-server-2025>|
...
| Microsoft Exchange Server Subscription Edition | [] |<https://learn.microsoft.com/en-us/exchange/new-features/build-numbers-and-release-dates?view=exchserver-2019&WT.mc_id=M365-MVP-5003086#exchange-server-se>| as there is no ISO for Exchange Server it's best to download it directly into you designated VM (use the latest CU) or build your own ISO from the lates CU|
...
| System Center 2025 |[X]|<https://www.microsoft.com/en-us/evalcenter/evaluate-system-center-2025>|
